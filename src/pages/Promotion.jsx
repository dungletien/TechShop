...
const sliderBanners = [bannerSale1, bannerSale2];
const coupons = [
    {
        code: "SALE50",
        condition: "Giảm 50K cho đơn từ 1 triệu",
        expiry: "31/12/2024",
        color: "rose",
    },
    {
        code: "FREESHIP",
        condition: "Miễn phí vận chuyển toàn quốc",
        expiry: "30/06/2024",
        color: "blue",
    },
    {
        code: "MEMBER10",
        condition: "Giảm 10% cho thành viên mới",
        expiry: "31/12/2024",
        color: "green",
    },
];
...
const promoTabs = [
    {
        key: "flash",
        label: "Flash Sale",
        icon: <ThunderboltOutlined className="text-pink-500 text-lg mr-2" />,
    },
    {
        key: "shock",
        label: "Giảm giá sốc",
        icon: <FireOutlined className="text-orange-500 text-lg mr-2" />,
    },
    {
        key: "combo",
        label: "Combo tiết kiệm",
        icon: <GiftOutlined className="text-blue-500 text-lg mr-2" />,
    },
    {
        key: "member",
        label: "Ưu đãi thành viên",
        icon: <UserOutlined className="text-green-500 text-lg mr-2" />,
    },
];
        ...
        <div className="min-h-screen bg-gray-50 pt-4 md:pt-6 pb-12">
            ...
            <div className="container mx-auto px-4 mb-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {coupons.map((coupon) => {
                        const color =
                            couponColorClass[coupon.color] ||
                            couponColorClass.violet;
                        return (
                            <div
                                key={coupon.code}
                            ...
                            >
                                <div className="flex items-center gap-2 mb-2">
                                    <span
                                        className={`text-lg font-bold ${color.text} ${color.bg} px-3 py-1 rounded-lg tracking-widest`}
                                    >
                                        {coupon.code}
                                    </span>
                                </div>
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    {filteredProducts.map((product) => (
                        <div
                            key={product.id}
                            className="bg-white rounded-xl shadow-sm hover:shadow-lg transition flex flex-col border border-gray-100"
                        >
                            <img
                                src={product.image}
                                alt={product.name}
                                className="h-40 mx-auto object-contain mt-4"
                            />
                            <div className="p-4 flex-1 flex flex-col">
                                ...
                                <div className="flex items-center mb-2">
                                    ...
                                    <span className="ml-2 text-xs font-medium text-white bg-rose-500 px-2 py-1 rounded-full">
                                        -{product.discount}%
                                    </span>
                                </div>
                                ...
                                <div className="flex gap-2 mt-auto">
                                    <Link
                                        ...
                                        className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg py-2 px-4 text-sm font-medium transition text-center"
                                    >
                                        Xem chi tiết
                                    </Link>
                                    <button
